...
SCRIPTS=(smart_fillable extract_fields modify_fields garbage_field_cleanup auto_rename_all auto_name_field fix_checkbox_appearances apply_acroform_fix)

# --onedir binaries (directory containing executable + shared libs — faster startup)
# fill_pdf_v3 is onedir to avoid 3-5s cold-start overhead from onefile's /tmp extraction
ONEDIR_SCRIPTS=(smart_fillable_server fill_pdf_v3)
