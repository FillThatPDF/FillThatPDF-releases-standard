...
output_json = "page2_geometry.json"
...
with pdfplumber.open(pdf_path) as pdf:
    ...
    for l in page.lines:
        data["lines"].append({
            "x0": float(l['x0']), "top": float(l['top']),
            "x1": float(l['x1']), "bottom": float(l['bottom']),
    ...
    for r in page.rects:
        data["rects"].append({
            ...
            "x1": float(r['x1']), "bottom": float(r['bottom']),
...
print(f"Dumped Page 2 geometry to {output_json}")
