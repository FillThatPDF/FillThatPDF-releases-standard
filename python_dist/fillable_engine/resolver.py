    ...
    def _prefilter(self, candidates: List[FieldCandidate],
        ...
        for c in candidates:
            ...
            if c.field_type == FieldType.TEXT and c.source not in (
                ...
                'horizontal_line_table', 'adjacent_empty_cell',
            ...
            # Exception: adjacent_empty_cell is detected from actual table
            # geometry (empty rect + adjacent label text) — forms that embed
            # a raster scan as a background layer still have real vector
            # rectangles defining the table cells.
