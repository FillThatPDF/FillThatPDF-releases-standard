...
parser = argparse.ArgumentParser(description='QA report for restored checkbox PDF')
parser.add_argument('--pdf', required=True)
parser.add_argument('--out', default='overlays/test_57643_QA_restored')
...
d = UniversalPDFFillable(PDF_PATH, settings={'disable_checkboxes_in_table_cells': False})
